...
# 1
hist(mtcars$hp, main = "Histogram HP", col = "lightblue")

# 2
boxplot(mtcars$hp, main = "Boxplot HP", col = "lightgreen")
...
# 2. Line plot
plot(1:4, Q1, type="l", col="blue", ylim=c(100,220),
     xlab="Quý", ylab="Doanh thu")
lines(1:4, Q2, col="red")
lines(1:4, Q3, col="green")
lines(1:4, Q4, col="purple")
...
# 3. Tổng doanh thu mỗi quý
total_quarter <- colSums(data_matrix)
...
# Grouped
barplot(data_matrix, beside=TRUE, col=rainbow(4))
...
# Pie (tổng quý)
pie(rowSums(data_matrix),
    labels=c("Q1","Q2","Q3","Q4"),
    col=rainbow(4))

# Bar (tổng sản phẩm)
barplot(colSums(data_matrix),
        names.arg=products,
        col=rainbow(4))
